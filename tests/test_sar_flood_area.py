...
class ProgressTests(unittest.TestCase):
    ...
    def test_round_trip(self):
        with tempfile.TemporaryDirectory() as tmp:
            state = {"done_blocks": [0, 3], "counts": {"no_water_px": 5,
                     ...
                     "patches": 4, "failed_blocks": [9], "total_blocks": 20}
    ...
    def test_save_is_atomic(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            sfa.save_progress(tmp, "E001", {"done_blocks": [1], "counts":
                              sfa._zero_counts(), "patches": 0,
                              "failed_blocks": [], "total_blocks": 2})
...
class ResultTests(unittest.TestCase):
    @staticmethod
    def _row(ev, km2):
        return {"event_id": ev, "state": "Assam", "flood_km2": km2, "status": "OK"}
    ...
    def test_state_dir_is_self_contained(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            sfa.save_progress(tmp, "E001", {"done_blocks": [0],
                              "counts": sfa._zero_counts(), "patches": 1,
                              "failed_blocks": [], "total_blocks": 5})
